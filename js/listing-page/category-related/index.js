        ...
        .then(data => {
            data.shift();
                  ...
                  // dont delete below comments
                    ...
                    // <div class="cm_vehicle-categories_category-wrapper">
                    //     <a class="cm_vehicle-categories_category-container cm_vehicle-categories_link" href="${subCat.url}">
                    //         ${returnCategoryImage(subCat.image)}
                    //         <div class="cm_vehicle-categories_category-title-container cm_vehicle-categories_link">
                    //             <h5 class="cm_vehicle-categories_category-title">
                    //                 ${subCat.name}
                    //             </h5>
                    //         </div>
                    //     </a>
