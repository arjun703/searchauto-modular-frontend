								...
								<div class="facet-option">
									<div class="facet-input-and-label">
										...
										<div class="facet-label-wrapper">
											<label class="facet-label" for="cb-${a}">
										    	${e.label}
											</label>
										</div>
									</div>
